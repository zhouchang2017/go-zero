...
func init() {
	...
	ddlCmd.Flags().StringVar(&command.VarStringStyle, "style", "go_zero", "The file naming format, see [https://github.com/zeromicro/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	datasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "go_zero", "The file naming format, see [https://github.com/zeromicro/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	pgDatasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "go_zero", "The file naming format, see [https://github.com/zeromicro/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	mysqlCmd.PersistentFlags().StringSliceVarP(&command.VarStringSliceIgnoreColumns, "ignore-columns", "i", []string{}, "Ignore columns while creating or updating rows")
